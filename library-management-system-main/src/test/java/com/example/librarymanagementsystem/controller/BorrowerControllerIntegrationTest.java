...
import com.library.management.controller.BorrowerController;
...
class BorrowerControllerIntegrationTest {
    ...
    void testBorrowBook() throws Exception {
        ...
        Mockito.doNothing().when(borrowerService).borrowBook(Mockito.any(), Mockito.any());
    ...
    void testReturnBook() throws Exception {
        ...
        Mockito.doNothing().when(borrowerService).returnBook(Mockito.any(), Mockito.any());
